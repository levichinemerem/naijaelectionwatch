      ...
      <div className="mobile-panel" style={{
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 32, paddingTop: 8 }}>
          ...
          <button onClick={() => setMenuOpen(false)} style={{
            ...
            color: C.body, padding: 8, borderRadius: 8, cursor: "pointer",
          }}>
...
function Hero() {
  ...
  const statColors = [C.mint, C.mint, C.mint, C.mint];
    ...
    <section style={{ background: C.pageBg, padding: "64px 5vw" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20, flexWrap: "wrap", gap: 12 }}>
          <h2 style={{
            fontSize: 11, fontWeight: 700, color: C.body, margin: 0,
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 32, flexWrap: "wrap", gap: 12 }}>
          ...
          <a href="/education" style={{
            fontSize: 13, color: C.brandMedium, textDecoration: "none", fontWeight: 600,
            ...
            <div key={col.title}>
              ...
              {col.links.map(link => (
                <a key={link} href="#" style={{
                  display: "block", fontSize: 13, color: C.white70,
          ...
          <div style={{ display: "flex", gap: 10 }}>
            {["𝕏", "in", "f", "▶"].map((icon, i) => (
              <div key={i} style={{
                ...
                display: "flex", alignItems: "center", justifyContent: "center",
                fontSize: 13, cursor: "pointer", color: C.white70,
                transition: "all 0.2s",
              }}
